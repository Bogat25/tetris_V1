...
void pr_kilepes()
{
    ...
    printf(CYAN_TEXT "Keszitette: Csani#3902");
    printf(RESET_TEXT);
}
void pr_iranyitas()
{
    printf(YELLOW_TEXT "Iranyitas.\n");
    printf(CYAN_TEXT "Balra : ");
    printf(YELLOW_TEXT "a\n");
    printf(CYAN_TEXT "Jobbra: ");
    printf(YELLOW_TEXT "d\n");
    printf(CYAN_TEXT "Iranytvalt: ");
    printf(YELLOW_TEXT "w\n");
    printf(RESET_TEXT);
}
#endif